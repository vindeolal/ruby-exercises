...
def add_seat_to_row(chart, row_index, seat_to_add)
  ...
  col_size = chart[row_index].length
  chart[row_index][col_size] = seat_to_add
  chart
end
...
def add_another_row(chart, row_to_add)
  ...
  row_size = chart.length
  chart[row_size] = row_to_add
  chart
end
...
def count_empty_seats(chart)
  ...
  chart.flatten.select { |c| c == nil }.length
end
...
def find_favorite(array_of_hash_objects)
  ...
  array_of_hash_objects.find { |h| h[:is_my_favorite?] }
end
